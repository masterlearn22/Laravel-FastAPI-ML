...
<body>
  <div class="container">
    <!-- HEADER -->
    <header>
      <h1>Prediksi Mamalia</h1>
      <p class="subtitle">Identifikasi spesies mamalia menggunakan AI</p>
    </header>
    ...
    <!-- MAIN FORM -->
    <form action="{{ route('mammals.predict') }}" method="POST" enctype="multipart/form-data">
      @csrf
